...
public class Diana_Bullet2_parent : Diana_Bullet2_data {
	...
	public override void collision_after ()
	{
		...
		diana_bullet2_data = PhotonNetwork.Instantiate("Diana_Bullet2", transform.position, Quaternion.identity,0).GetComponent<Diana_Bullet2_data>();
		type = 1;
